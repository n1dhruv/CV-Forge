...
const formCopy: Record<ItemType, { titleLabel: string; titlePlaceholder: string; orgLabel: string; orgPlaceholder: string; notesPlaceholder: string; ongoingLabel: string }> = {
  ...
  project: { titleLabel: 'Project name', titlePlaceholder: 'MakeMyResume', orgLabel: 'Organization', orgPlaceholder: 'Company, client, or independent', notesPlaceholder: 'Problem, contribution, stack, and verified outcomes…', ongoingLabel: 'This project is active' },
